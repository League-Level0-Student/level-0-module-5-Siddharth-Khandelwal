...
String hours = JOptionPane.showInputDialog("How many hours have you coded for this week?");
	int Hours = Integer.parseInt(hours);
	if(Hours<=2) {
JOptionPane.showMessageDialog(null, "Stop watching Youtube, start writing code!");
	}	
	...
	// N}OTE: Download batman.wav from league-sounds on GitHub: https://github.com/jointheleague/league-sounds
